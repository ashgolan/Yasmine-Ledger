...
export default function LoginPage() {
  ...
  return (
    <div style={{
      ...
      <div style={{
        flex: 1, background: "#534AB7", display: "flex", flexDirection: "column",
        ...
        <div style={{ animation: "float 4s ease-in-out infinite", marginBottom: 32, position: "relative", zIndex: 1 }}>
          <div style={{
            width: 80, height: 80, borderRadius: 22, background: "rgba(255,255,255,0.15)",
        ...
        <div style={{ position: "relative", zIndex: 1, textAlign: "center" }}>
          <div style={{ fontSize: 32, fontWeight: 800, color: "#fff", marginBottom: 10, letterSpacing: "-0.02em" }}>
            Yasmine Ledger
          </div>
      ...
      <div style={{
        ...
        <div style={{ width: "100%", maxWidth: 380, animation: "fadeUp 0.4s ease" }}>
          ...
          <div style={{ marginBottom: 36 }}>
            <div style={{ fontSize: 11, color: "#534AB7", fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 8 }}>
              ברוך הבא
            </div>
            <div style={{ fontSize: 26, fontWeight: 800, color: "#1a1a1a", marginBottom: 6 }}>התחברות למערכת</div>
          ...
          {error && (
            <div style={{
              ...
              borderRadius: 9, padding: "11px 14px", fontSize: 13, fontWeight: 600,
              marginBottom: 20,
            }}>
              {error}
            </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                <div style={{ position: "absolute", top: "50%", right: 12, transform: "translateY(-50%)", color: "#bbb", pointerEvents: "none" }}>
                  {Icon.user}
                </div>
                <input
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <button
                  ...
                  style={{ position: "absolute", top: "50%", left: 12, transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", color: "#bbb", padding: 0, display: "flex" }}
                >
